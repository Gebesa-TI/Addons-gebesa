...
class SaleOrder(models.Model):
    ...
    order_replaced = fields.Many2one('sale.order', 
    ...
    def send_email_orders_canceled(self):
        ...
        for res in order_ids:
            ...
            table += """
                <tr><td style="border-bottom: 1px solid silver;">%s</td>
                    ...
                    <td style="border-bottom: 1px solid silver;">%s</td>
                    <td align="right" style="border-bottom: 1px solid silver;">%s</td></tr>
        ...
        body_mail = u"""
            <div summary="o_mail_notification" style="padding:0px; width:700px; margin:0 auto; background: #FFFFFF repeat top /100%%; color:#777777">
                <table cellspacing="0" cellpadding="0" style="width:700px; border-collapse:collapse; background:inherit; color:inherit">
                    <tbody><tr>
                        <td valign="center" width="270" style="padding:5px 10px 5px 5px;font-size: 18px">
                            <p>Los siguientes pedidos fueron Cancelados y/o Cerrados</p>
                        </td>
            ...
            <div style="padding:0px; width:700px; margin:0 auto; background: #FFFFFF repeat top /100%%;color:#777777">
                <table style="border-collapse:collapse; margin: 0 auto; width:700px; background:inherit; color:inherit">
                    <tbody><tr>
                        <th width="16%%" style="padding:5px 10px 5px 5px;font-size: 14px; border-bottom: 2px solid silver;"><strong>Fecha de Cancelacion y/o Cerrado</strong></th>
                        <th width="54%%" style="padding:5px 10px 5px 5px;font-size: 14px; border-bottom: 2px solid silver;"><strong>Cliente</strong></th>
                        <th width="15%%" style="padding:5px 10px 5px 5px;font-size: 14px; border-bottom: 2px solid silver;"><strong>Pedido</strong></th>
                        <th width="15%%" style="padding:5px 10px 5px 5px;font-size: 14px; border-bottom: 2px solid silver;"><strong>Pedido que Sustituye</strong></th>
                    </tr>
                    %s
                    </tbody>
                </table>
        ...
        mail = mail_obj.create({
            ...
            'email_to': 'esther.cisneros@gebesa.com',
