...
class AccountInvoice(models.Model):
    ...
    def send_email_invoice_canceled(self):
        ...
        mail = mail_obj.create({
            ...
            'email_to': 'sergio.hernandez@gebesa,pedro.acosta@gebesa.com,andrea.mejia@gebesa.com,monica.sanchez@gebesa.com,jesus.castrellon@gebesa.com,cristina.rodriguez@gebesa.com,esmeralda.gutierrez@gebesa.com,sistemas@gebesa.com',
